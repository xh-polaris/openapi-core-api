...
type FullInterface struct {
	...
	ChargeType      ChargeType      `protobuf:"varint,4,opt,name=chargeType,proto3,enum=openapi.charge.ChargeType" form:"chargeType" json:"chargeType" query:"chargeType"` // 收费模式
	Price           int64           `protobuf:"varint,5,opt,name=price,proto3" form:"price" json:"price" query:"price"`                                                    // 接口单价
	Margin          int64           `protobuf:"varint,6,opt,name=margin,proto3" form:"margin" json:"margin" query:"margin"`                                                // 接口余量
...
var file_openapi_charge_common_proto_rawDesc = []byte{
	...
	0x7f, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x68, 0x70, 0x6f, 0x6c, 0x61, 0x72, 0x69, 0x73,
	...
	0x6f, 0x2f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65,
